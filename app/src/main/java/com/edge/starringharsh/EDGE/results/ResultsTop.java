...
public class ResultsTop extends BaseActivity {
    ...
    class TextOnClickListener implements TextView.OnClickListener {
        ...
        public void onClick(View v) {
            Intent intent;
            if(isTop) {
                intent = new Intent(ResultsTop.this.getApplicationContext(), ResultsTop.class);
                intent.putExtra(ResultsTop.HEADER_CAPTION, eventName);
                intent.putExtra(ResultsTop.RESULTS_URL, url);
            } else {
                intent = new Intent(ResultsTop.this.getApplicationContext(), ResultsDetails.class);
