...
class Rules {
    ...
    Rules() {
        ...
        rules.put("ELECTRONICALLY YOURS", R.string.rules_electronically_yours);
        ...
        rules.put("EDGE ZOOM", R.string.rules_placeholder);
        rules.put("UDAAN", R.string.rules_placeholder);
        rules.put("1 MINUTE STAND", R.string.rules_placeholder);
