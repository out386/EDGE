...
import com.edge.starringharsh.EDGE.ComingSoon;
...
public class EventList extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (n) {
            case 0:
                events = master.events0;
                break;

            case 1:
                events = master.events1;
                break;

            case 2:
                events = master.events2;
                break;

            case 3:
                events = master.events3;
                break;

            case 4:
                events = master.events4;
                break;

            case 5:
                events = master.events5;
                break;

            case 6:
                events = master.events6;
                break;

            case 7:
                events = master.events7;
                break;

            case 8:
                events = master.events8;
                break;

            case 9:
                events = master.events9;
                break;

            case 10:
                events = master.events10;
                break;

            case 11:
                events = master.events11;
                break;
        ...
        TextView tvHead = findViewById(R.id.tvHeader);
